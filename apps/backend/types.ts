...
export const userDetailsSchema = z.object({
  ...
  lcUrl: z
    .string()
    .includes("https://leetcode.com/", { position: 0 })
    .optional(),
  cfUrl: z
    .string()
    .includes("https://codeforces.com/", { position: 0 })
    .optional(),
  wakatimeApi: z.string().optional(),
});
...
export const questionTypeSchema = z.enum(["mcq", "dsa", "backend", "frontend"]);
export const difficultySchema = z.enum(["easy", "medium", "hard"]);

export const questionConfigSchema = z.object({
  questionTypes: z.array(questionTypeSchema),
  questionsPerType: z.number().min(1).max(20),
